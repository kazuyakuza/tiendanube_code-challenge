...
- src/transactions/ - Transaction orchestration + HTTP endpoint (TODO-05 service, TODO-06 Cycle A controller): TransactionsModule registers TransactionsController (POST /v1/transactions — live route: guard 401, ValidationPipe 400, 201 envelope/bare-201 via the TRANSACTIONS_RETURN_BODY service gate) + TransactionsService (9-step create() flow) + pure fee-rules.ts; DTOs and custom validators in dto/; exception-filter/502-503 mapping + compensation pending TODO-06 Cycle B
